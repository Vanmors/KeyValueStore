...
public class BootstrapProperties {
    ...
    public void setJoinAddress(final String joinAddress) {
    ...
    public static class Bootstrap {
        ...
        public List<ShardInfo> getInitialShards() {
            return initialShards;
        }

        public void setInitialShards(final List<ShardInfo> initialShards) {
            if (initialShards == null) {
                this.initialShards = new ArrayList<>();
            } else {
                this.initialShards = new ArrayList<>(initialShards);
            }
        }
    }
}
